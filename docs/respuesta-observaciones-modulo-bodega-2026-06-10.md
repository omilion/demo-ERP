...
| 2.3 | Falta agregar precio licitación | ✅ Implementado (11-06) | **Campo manual "Precio licitación" por producto** agregado a la ficha (sección Precios). Si se ingresa, sobrescribe al precio calculado y se refleja en Bodega (columna "P. licitación"), Consulta de Precios y exportaciones. Si se deja vacío, sigue el cálculo automático (costo + % licitación del proveedor). |
