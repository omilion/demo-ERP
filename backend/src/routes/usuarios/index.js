  ...
  fastify.put('/:id', {
    ...
    try {
      ...
      const accessChanged = Boolean(
        ...
        || (data.permisosExtra !== undefined && !sameJson(data.permisosExtra, current.permisosExtra))
        || (data.tiposVentaPermitidos !== undefined && !sameJson(data.tiposVentaPermitidos, current.tiposVentaPermitidos))
      )
      if (accessChanged) {
