...
const NAV_GROUPS = [
  { label: 'Ventas', items: [
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'Convenio Marco', route: '/crm/nueva/convenio-marco' },
      ],
    },
  ...
  { label: 'Admin', items: [
    ...
    { label: 'Auditoría', route: '/admin/auditoria', roles: ['admin'] },
  ] },
  { label: 'AYUDA', items: [
    ...
    { label: 'Copiloto IA', route: '/asistente', allAuthenticated: true },
    { label: 'Alertas operativas IA', route: '/asistente/alertas', allAuthenticated: true },
