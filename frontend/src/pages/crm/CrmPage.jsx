        ...
        actions={<>
          <div style={{ position: 'relative' }}>
            ...
            {newOpportunityMenu && <div style={{ position: 'absolute', right: 0, top: 'calc(100% + 6px)', zIndex: 50, minWidth: 270, padding: 7, background: '#fff', border: '1px solid var(--border)', borderRadius: 9, boxShadow: 'var(--shadow-md)' }}>
              ...
              <Link to="/crm/nueva/licitacion" onClick={() => setNewOpportunityMenu(false)} style={{ display: 'block', padding: '10px 11px', borderRadius: 7, color: 'var(--text-1)', textDecoration: 'none' }}><div style={{ fontSize: 13, fontWeight: 750 }}>Licitacion</div><div style={{ marginTop: 2, fontSize: 11, color: 'var(--text-3)' }}>Bases, plazos, productos y seguimiento comercial.</div></Link>
              <Link to="/crm/nueva/convenio-marco" onClick={() => setNewOpportunityMenu(false)} style={{ display: 'block', padding: '10px 11px', borderRadius: 7, color: 'var(--text-1)', textDecoration: 'none' }}><div style={{ fontSize: 13, fontWeight: 750 }}>Convenio Marco</div><div style={{ marginTop: 2, fontSize: 11, color: 'var(--text-3)' }}>Cotización y seguimiento antes de ingresar la venta.</div></Link>
