...
const s = {
  ...
  input: { padding: '9px 12px', borderRadius: 8, border: '1px solid var(--border)', fontSize: 13, outline: 'none', fontFamily: 'inherit', color: 'var(--text-1)' },
  error: { fontSize: 12, color: 'var(--red)', textAlign: 'center' },
  btn:   { padding: '11px 0', background: 'var(--green-700)', color: '#fff', borderRadius: 9, fontWeight: 600, fontSize: 13, cursor: 'pointer', border: 'none', marginTop: 4 },
}
