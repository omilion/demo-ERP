...
function CorteCard({ item, operarios, canWrite, onAssign, onChangeState, onAdvance }) {
  ...
  return (
    <article style={{ ...panelStyle, display: 'flex', flexDirection: 'column', gap: 11 }}>
      ...
      <div style={{ height: 8, background: 'var(--bg)', borderRadius: 99, overflow: 'hidden' }}><div style={{ width: `${Math.min(100, progress.porcentaje)}%`, height: '100%', background: progress.porcentaje >= 100 ? 'var(--green-600)' : 'var(--blue)', transition: 'width .2s' }} /></div>
